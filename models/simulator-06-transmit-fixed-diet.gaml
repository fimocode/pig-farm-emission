...
experiment TransmitFixedDiet {
	...
	reflex log when: mod(cycle, 24 * 60) = 0 {
		ask simulations {
			...
			save [floor(cycle / (24 * 60)), total_CO2_emission, total_CH4_emission] to: "../includes/output/transmit-fixeddiet/" + experiment_id + "-emission" + ".csv" rewrite: false format: "csv";
		}
